...
public abstract class SaizadBaseBottomSheetDialogFragment<V extends SaizadBaseViewModel> extends DaggerBottomSheetDialogFragment implements FragmentAppLifecycleDelegate, FragmentCB<V>, FragmentAppLifecycleCallBack {

    protected FragmentAppLifecycleDelegate delegate;


    public SaizadBaseBottomSheetDialogFragment() {
