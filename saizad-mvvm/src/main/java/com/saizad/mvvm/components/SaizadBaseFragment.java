...
public abstract class SaizadBaseFragment<V extends SaizadBaseViewModel> extends DaggerFragment implements FragmentAppLifecycleDelegate, FragmentCB<V>, FragmentAppLifecycleCallBack {

    protected FragmentAppLifecycleDelegate delegate;


    public SaizadBaseFragment() {
