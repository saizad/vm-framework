...
import com.vm.framework.VmFrameworkRequestCodes
...
abstract class FilesFieldView @JvmOverloads constructor(
    ...
    private lateinit var baseViewModel: VmFrameworkBaseViewModel
    ...
    fun setup(
        fragment: Fragment,
        baseViewModel: VmFrameworkBaseViewModel,
    ...
    private fun openPicker() {
        parentFragment.activity?.startActivityForResult(intent(), VmFrameworkRequestCodes.PICK_FILE)
    }
