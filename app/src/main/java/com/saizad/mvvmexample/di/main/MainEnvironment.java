...
public class MainEnvironment extends Environment {
    ...
    @Inject
    public MainEnvironment(FCMToken fcmToken, MainApi authApi, BehaviorSubject<ActivityResult<?>> behaviorSubject, CurrentUserType currentUser, PermissionManager permissionManager, @Named("notification") BehaviorSubject<NotifyOnce<?>> notifyOnceBehaviorSubject) {
